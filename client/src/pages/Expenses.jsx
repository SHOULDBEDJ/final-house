  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1>Expenses</h1>
          <p className="subtitle">Monitor and manage venue costs</p>
        </div>
            ...
            <tbody>
              {data.map((item) => (
                <tr key={item.id}>
                  ...
                  <td style={{ color: 'var(--red)', fontWeight: 600 }}>-₹{item.amount.toLocaleString()}</td>
                </tr>
              ))}
          ...
          <div className="modal-card" style={{ maxWidth: '450px' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '20px' }}>
                <button type="button" className="btn-amber" onClick={() => setShowModal(false)} style={{ background: 'white', color: '#555', border: '1px solid #ddd' }}>CANCEL</button>
